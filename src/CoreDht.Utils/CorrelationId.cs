...
{
    /// <summary>
    /// Represents an operation or a series of operations with a base58 encoded GUID
    /// </summary>
    public struct CorrelationId
    {
        ...
        /// </summary>
        /// <param name="obj">The object to compare. Can be a Guid or a CorrelationId</param>
        /// <returns></returns>
